...
async def get_lobby_request(request):
    response = apex_events.get_lobby_players()
    await asyncio.sleep(1)
    lobby_players = apex_events.get_data_store().get('rtech.liveapi.CustomMatch_LobbyPlayers', {})
